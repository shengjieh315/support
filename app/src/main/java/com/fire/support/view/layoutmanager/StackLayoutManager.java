package com.fire.support.view.layoutmanager;
...
public class StackLayoutManager extends RecyclerView.LayoutManager {
     ...
     * 水平方向累计偏移量
     */
    private long mHorizontalOffset = -1;
    ...
    public StackLayoutManager(Context context, int initPosition) {
        normalViewGap = dp2px(context, 0);
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (mHorizontalOffset == -1) {
            View tempView = recycler.getViewForPosition(0);
            measureChildWithMargins(tempView, 0, 0);
            int childWidth = getDecoratedMeasurementHorizontal(tempView);
            mHorizontalOffset = initPosition * childWidth;
        }
    ...
    public int findShouldSelectPosition() {
        ...
        KLog.e("findShouldSelectPosition = " + position);
    ...
    private void startValueAnimator(final int position) {
        ...
        selectAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (listener != null) {
                    listener.onFocusAnimEnd(position);
                }
            }
        });
    ...
    private OnStackListener listener;

    public interface OnStackListener {
        void onFocusAnimEnd(int position);
    }

    public void setListener(OnStackListener listener) {
        this.listener = listener;
    }

    public boolean isClickCenter(int position) {
        return getScrollToPositionOffset(position) == 0;
    }
