...
public class TurnLayoutManager extends LinearLayoutManager {
     ...
     */
    public TurnLayoutManager(RecyclerView recyclerView, Context context,
                             @Gravity int gravity,
    ...
    public TurnLayoutManager(RecyclerView recyclerView, Context context,
                             @Dimension int radius,
                             @Dimension int peekDistance) {
        this(recyclerView, context, Gravity.START, Orientation.VERTICAL, radius, peekDistance, false);
    }
    ...
    private void setChildOffsetsVertical(@Gravity int gravity,
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            final int xOffset = (int) resolveOffsetX(radius, child.getY() + child.getHeight() / 2 + top, center, peekDistance);
